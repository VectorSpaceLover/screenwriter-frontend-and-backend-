          ...
          <div class="col-lg-12">
            ...
            <div class="card">
              <div class="card-title">
                <h4 class="pt-3 ml-3">New Page</h4>

              </div>
              <div class="card-body">


                <form class="form-horizontal"  method='post' id='new_page_form'>
                  <input type='hidden' id='page_id' name='page_id' value=''>
                  <input type='hidden' id='function' name='function' value='newpage'>
                  ...
                  <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                      <button type="submit" class="btn btn-primary" id="new_page"><i class='fa fa-save'></i> Save</button>
